...
class _PayChanguInlineCheckoutScreenState extends State<PayChanguInlineCheckoutScreen> {
  ...
  Future<void> _initiateCheckout() async {
    if (widget.amount < 50) {
      setState(() {
        _isLoading = false;
        _errorMessage = 'Minimum payment amount is MWK 50. Please add more items or choose another payment method.';
      });
      return;
    }
    setState(() {
    ...
    try {
      ...
      final response = await Supabase.instance.client.functions.invoke(
        ...
        body: {
          ...
          'tx_ref': _txRef,
          'callback_url': 'https://boqgamdpxjejneyjnsgz.supabase.co/functions/v1/paychangu-webhook',
