...
class _RegistrationPageState extends State<RegistrationPage> {
  ...
  // Customer-only on registration page; operators go through login flow
  ...
  Future<void> _register() async {
    ...
    try {
      ...
      if (mounted) {
        if (_selectedUserType == 'operator') {
          // Operator registered — now create their restaurant
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (_) => const RestaurantRegistrationPage()),
          );
        } else {
          // Customer — show success dialog
          _showSuccessDialog();
        }
      }
    ...
    return Form(
      ...
      child: Column(
        ...
        children: [
          ...
          // User Type Selection (customer only)
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const Text(
              ...
              TextButton(
                onPressed: _isLoading
                  ...
                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                      builder: (_) => const LoginPage(preselectedRole: 'operator'),
                    ),
                  );
                },
                style: TextButton.styleFrom(
